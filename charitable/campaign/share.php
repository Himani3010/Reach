    ...
    <li class="share-widget">
        ...
        <div id="campaign-widget-<?php the_ID() ?>" class="modal">
            ...
            <div class="block"> 
                ...
                <pre><?php echo htmlspecialchars( '<iframe src="' . charitable_get_permalink( 'campaign_widget_page' ) . '" width="275" height="468" /></iframe>' ) ?></pre>
            </div>
            <div class="block iframe-block">
                <p><strong><?php _e( 'Preview', 'reach' ) ?></strong></p>
                <iframe src="<?php echo esc_attr( charitable_get_permalink( 'campaign_widget_page' ) ) ?>" width="275" height="468" /></iframe>
            </div>
        </div>
    </li>   
</ul>