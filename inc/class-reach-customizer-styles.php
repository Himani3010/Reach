...
<style id="customizer-styles" media="all" type="text/css">
    ...
    private function get_accent_colour_css() {
        ...
        $output .= ".site-navigation.toggled .menu-site { border-top-color: $colour; }";
        return $output;
    }
