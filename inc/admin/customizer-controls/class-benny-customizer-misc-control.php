...
if ( ! class_exists( 'Benny_Customizer_Misc_Control' ) ) :

/**
 * Class Benny_Customizer_Misc_Control
 *
 * Control for adding arbitrary HTML to a Customizer section.
 *
 * @since 1.0.0
 */
class Benny_Customizer_Misc_Control extends WP_Customize_Control {
    /**
    ...
    public function render_content() {
        switch ( $this->type ) {
            case 'group-title' :
                echo '<h4 class="benny-control-group-title">' . $this->label . '</h4>';
                if ( '' !== $this->description ) {
