<?php
/**
 * Sets up the theme page for Reach.
 *
 * @package     Reach/Classes/Reach_Admin_Page
 * @version     1.0.0
 * @author      Eric Daams
...
if ( ! class_exists( 'Reach_Admin_Page' ) ) : 
...
class Reach_Admin_Page {
    ...
    public function register_admin_page_styles() {
        ...
        wp_register_style( 'charitable-admin-pages', get_template_directory_uri() . '/css/vendor/charitable-admin-pages.min.css', array(), reach_get_theme()->get_theme_version() );
    }
            ...
            <ul class="recommended-plugins">
                ...
                <li class="premium">
                    ...
                    <ul>
                        ...
                        <li><p><?php printf( __( '<a href="%s"><strong>Charitable Anonymous Donations</strong></a> allows your donors to give without having their name displayed publicly in your donations widget.', 'reach' ), 'https://www.wpcharitable.com/extensions/charitable-anonymous-donations/?utm_source=reach-welcome-page&amp;utm_medium=wordpress-dashboard&amp;utm_campaign=upgrades' ) ?></p></li>
                    </ul>
                </li>
            </ul>
        </div>        
